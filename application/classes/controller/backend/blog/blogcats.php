...
class Controller_Backend_Blog_Blogcats extends Controller_Backend_Template { 
	
	public function before()
	{
		parent::before();
		
		$this->model = new Model_Blogcats;
	}
	...
	public function action_form()
	{
		...
		$id_parent = Arr::get($_GET, 'parent_id', Arr::get($data, 'parent_id', 0));
	
		$this->template->content->data = $data;
		$this->template->content->id_parent = $id_parent;
		$this->template->content->sections = $this->model->get_sections();
