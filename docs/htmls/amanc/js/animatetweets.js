...
$(document).ready(function(){	  
	// Twitter
	var displaylimit = 10;
    var twitterprofile = "palcos";
	var screenname = "Palcos";
	...
	var headerHTML = '';
	var loadingHTML = '';
	headerHTML += '<div id="twitter-header"><a href="https://twitter.com/" target="_blank"><img src="img/icon/twitter-bird-light.png" width="34" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
	...
	loadingHTML += '<div id="loading-container"><img src="img/icon/ajax-loader.gif" width="32" height="32" alt="tweet loader" /></div>';
				...
				//console.log(feeds[i]);
				 ...
				 if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) { 
					if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {             
						...
						feedHTML += '<div class="twitter-pic"><a href="https://twitter.com/'+tweetusername+'" target="_blank"><img src="'+profileimage+'"img/icon/twitter-feed-icon.png" width="42" height="42" alt="twitter icon" /></a></div>';
