		...
		<form name="save" action="" method="post" class="form validate" enctype="multipart/form-data">
			...
			<div class="fieldset">
				...
				<div class="field">
					...
					<input type="text" name="url" value="<?=$data['url']?>" class="" title="<?=__('Da la url')?>" />
				</div><br />
				<div class="field full">
				...
				<div class="field full">
					...
					<div class="file">
						...
						<div class="fname"<?php if($data['thumbnail']!=""): ?>style="display:block;"<?php endif; ?>>
							<a href="../assets/files/project/<?=$data['thumbnail']?>" target="_blank"><img src="../assets/files/project/<?=$data['thumbnail']?>" height="75" alt="" /></a>
							<a href="#" class="del">Delete</a>
							<a href="../assets/files/project/<?=$data['thumbnail']?>" target="_blank" class="iname"><?=$data['thumbnail']?></a>
