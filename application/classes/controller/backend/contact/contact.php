...
class Controller_Backend_Contact_Contact extends Controller_Backend_Template {
	...
	public function action_index()
	{
		...
		$order_by = Arr::get($_GET, 'order_by', 'contact.contactdate');
	...
	public function action_form()
	{
		...
		{	
			...
			if ( ! $valid->check())
			{
				$this->template->errors = $valid->errors('contact');
			}
			else
			{	
				if ($data['id'])
