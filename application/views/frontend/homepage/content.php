    ...
    <div class="container_interior">
    	<div class="inner-block">
			...
			<div class="areas">
               ...
               <li class="mix category-2" data-myorder="4">
                            <a href="img/secciones/lightbox.jpg" class="swipebox" title="Salón de usos múltiples">
                                <span><i class="fa fa-eye"></i></span>
                                <img src="img/secciones/sala2.jpg" alt="image">
                                 <strong>Salón de usos múltiples </strong>
                            </a>
                        </li>
                    	 <!--li class="mix category-1" data-myorder="2">
                            <a href="img/secciones/lightbox.jpg" class="swipebox" title="Salón de usos múltiples">
                                <span><i class="fa fa-eye"></i></span>
                                <img src="img/secciones/sala1.jpg" alt="image">
                                <strong>Salón de usos múltiples </strong>
                            </a>
                         </li>
                         <li class="mix category-2" data-myorder="4">
                    	 ...
                    	 <li class="mix category-1" data-myorder="1">
                            <a href="img/secciones/lightbox.jpg" class="swipebox" title="Salón de usos múltiples">
                                <span><i class="fa fa-eye"></i></span>
                                <img src="img/secciones/sala3.jpg" alt="image">
                                <strong>Salón de usos múltiples </strong>
                            </a>
                         </li>
                         <li class="mix category-2" data-myorder="8">
                            <a href="img/secciones/lightbox.jpg" class="swipebox" title="Salón de usos múltiples">
                                <span><i class="fa fa-eye"></i></span>
                                <img src="img/secciones/sala2.jpg" alt="image">
                                 <strong>Salón de usos múltiples </strong>
