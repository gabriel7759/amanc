...
class Controller_Backend_Manage_Project extends Controller_Backend_Template {
	...
	public function action_index()
	{
		...
		$order_by = Arr::get($_GET, 'order_by', 'project.title');
	...
	public function action_form()
	{
		...
		{	
			...
			if ( ! $valid->check())
			{
				$this->template->errors = $valid->errors('project');
			}
			else
			{
