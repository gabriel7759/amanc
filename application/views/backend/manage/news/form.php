		...
		<form name="save" action="" method="post" class="form validate" enctype="multipart/form-data">
			...
			<div class="fieldset">
				...
				<div class="field half">
					...
					<input type="text" name="newsdate" value="<?=Timestamp::format($data['newsdate'], '%Y-%m-%d')?>" class="required date" title="<?=__('Seleccione la fecha')?>" />
				</div><br />
				...
				<div class="field full">
					<label><?=__('Thumbnail')?> <span class="req"></span> <span>(max JPG 164 x 110)</span></label>
					<div class="file">
						<div class="fileinput">
